...
In addition, we discuss intrinsic isometries between surfaces and prove so-called Gauss' remarkable theorem, stating that \textit{Gauss curvature is an intrinsic invariant}.
...
Choose a unit vector field~$\Norm=\Norm(u,v)$ that is normal to $\Sigma$ at $s(u,v)$.
