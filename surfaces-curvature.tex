...
Recall that in the body in Lagunov's example contains a ball of radius $r_2=\tfrac2{\sqrt{3}}-1$.
...
Such $V$ is squeezed between two nearly parallel surfaces;
for example, between two large concentric spheres.

For bodies bounded by sphere, there is a better bound $r_3=\sqrt{\tfrac32}-1$;
...
These results were obtained by Vladimir Lagunov and Abram Fet \cite{lagunov-1960, lagunov-fet-1963, lagunov-fet-1965}.
