...
We say two surfaces $\Sigma_1$ and $\Sigma_2$ are \index{tangent!surfaces}\emph{tangent} at a point $p \in \Sigma_1 \cap \Sigma_2$ if they have a common tangent plane at~$p$.
...
Let us describe $\Sigma_1$ and $\Sigma_2$ locally at $p$ in tangent-normal coordinates as the graphs of functions $f_1(x,y)$ and $f_2(x,y)$ respectively.
...
In other words, there is an $(x,y,z)$-coordinate system in which $\Sigma$ lies in the region $z \z\ge m \cdot\sqrt{x^2 + y^2}$ for a constant $m > 0$.
\end{thm} 
