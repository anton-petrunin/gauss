...
Show that any closed surface in a unit ball has a point with Gauss curvature at least~1. In particular, any closed surface has a point with strictly positive Gauss curvature.
\end{thm}
