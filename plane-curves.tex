...
Note that if we reverse the parametrization of the curve or change the orientation of the plane, then
...
This is the fundamental theorem of differential geometry of plane curves.
It follows from \ref{thm:fund-curves}, but we present a slightly simpler proof.
...
Note that the \textit{osculating circle} might be a circle or a line.
...
if a smooth function is constant on each osculating circle, then it must be constant in the annulus \cite[see][Lecture 10]{fuchs-tabachnikov}.
