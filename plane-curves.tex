...
In the plane, it makes sense to talk about left (positive) turns and right (negative) turns. The signed curvature measures how fast a plane curve is turning either left or right; 
