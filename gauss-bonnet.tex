...
The proof goes along the same lines as \ref{lem:GB-sum}, but the combinatorics gets trickier.
...
Before reading the proof, try to derive the formula for the subdivision of the annulus $A$ on the diagram;
...
here $d$ denotes the \index{degree of vertex}\emph{degree} of $p$; that is, the number of edges that end at~$p$.
