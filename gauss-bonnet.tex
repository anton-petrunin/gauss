...
Equivalently, any closed curve in $\Sigma$ can be deformed into a \index{trivial curve}\emph{trivial curve}; that is, a curve that stands at one point all the time.
