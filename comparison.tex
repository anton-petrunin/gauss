...
If $\Sigma$ is an closed (or open) simply-connected smooth surface with nonnegative Gauss curvature, then 
...
The proofs of parts \ref{SHORT.thm:comp:cat} and \ref{SHORT.thm:comp:toponogov} will be given in section~\ref{sec:nonpos-comp} and ~\ref{sec:nonneg-comp} respectively.
