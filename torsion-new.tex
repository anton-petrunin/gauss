...
the only-if part of the theorem follows from \ref{SHORT.ex:lancret:a}
and the if part from \ref{SHORT.ex:lancret:b}
...
the only-if part follows from \ref{SHORT.ex:spherical-frenet:kur-tor}, and the if part from \ref{SHORT.ex:spherical-frenet:f}.
