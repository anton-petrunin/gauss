...
Let $\gamma_0\:[a,b]\to \mathbb{R}^3$ be a smooth regular space curve with Frenet frame $\tan,\norm,\bi$.
...
Let $\gamma$ be a closed smooth regular space curve with positive torsion.
