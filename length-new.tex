...
А curve is called \index{rectifiable curve}\emph{rectifiable} if its length is finite.
...
Note that it is sufficient to show that the \index{diameter}\emph{diameter} of $\gamma$ is at most 2;
that is, 
