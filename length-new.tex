...
\end{subthm}
%I think constructing a "simple curve with derivative 0 a.e." is much harder than a "non-constant curve with derivative 0 a.e." and any of them work as counterexample.
...
By Proposition~\ref{prop:convex-curve}, the length of the curve cannot exceed $8\cdot C$ --- the perimeter of the square; hence the result.
\qeds
...
We claim that $\gamma$ lies in the open north hemisphere with north pole at $z$. %???the north pole???
