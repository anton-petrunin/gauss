...
We say that something is \index{intrinsic}\emph{intrinsic} if it can be checked or measured within the surface;
...
A cowboy stands at the bottom of a frictionless ice-mountain in the shape of a right circular cone with the angle of inclination~$\theta$.
He throws up his lasso, which slips neatly over the tip of the cone, pulls it tight, and tries to climb.
Assume that the lasso slides without friction.
If $\theta$ is large, it will work, and if it is small, the lasso will slide
away.
What is the borderline angle?
\end{thm}
...
that is,
\[|\gamma_n(t_0)-\gamma_n(t_1)|\le (\ell+1)\cdot|t_0-t_1|\]
for any $t_0,t_1\in[0,1]$ and $n$.
