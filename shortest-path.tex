...
A property is called \index{intrinsic property}\emph{intrinsic} if it can be checked by measurements inside the surface; for example, lengths of curves or angles between the curves that lie in the surface.
...
The image of a shortest path between $p$ and $q$ in $\Sigma$ is usually denoted by $[p,q]$ or $[p,q]_\Sigma$.\index{10aac@$[p,q]$, $[p,q]_\Sigma$}
