...
Later (\ref{thm:remarkable}) it will be shown that {}\emph{remarkably} the Gauss curvature is intrinsic --- it can be calculated via measurements inside the surface.
