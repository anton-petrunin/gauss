...
Give an example of two proper curves $\gamma_0$ and $\gamma_1$ satisfying the above condition such that $\gamma_0$ does \textit{not} support $\gamma_1$ at $p$ \textit{globally}.
\end{thm}
