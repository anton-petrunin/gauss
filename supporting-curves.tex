...
When two plane curves are tangent and do not cross, it is possible to control the signed curvature of one of them in terms of the signed curvature of other one. In this chapter, we discuss how to use this idea to better understand the situations in which we have a curve acting as a barrier surrounding another curve.
