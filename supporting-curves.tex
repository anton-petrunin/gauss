...
If the curves on the picture are oriented according to the arrows, then $\gamma_1$ supports $\gamma_2$ from the right at $p$ (as well as $\gamma_2$ supports $\gamma_1$ from the left at~$p$).
...
Small arcs $\gamma_1|_{[-\epsilon,+\epsilon]}$ and $\gamma_2|_{[-\epsilon,+\epsilon]}$ can be described as a graph 
...
The curvature $\skur_\sigma$ of the incircle $\sigma$ has to be larger than $\skur(p)_\gamma$.
