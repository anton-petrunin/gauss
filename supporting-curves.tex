...
Further, suppose $\gamma_2$ is a closed simple plane curve.
...
In this case, we say that $\gamma_1$ supports $\gamma_2$ \index{support}\emph{from the inside} (\index{support}\emph{from the outside}) if $\gamma_1$ supports $\gamma_2$ and lies in the region inside $\gamma_2$ (respectively outside $\gamma_2$). 
...
Assume a closed smooth curve $\gamma$ lies in a figure $F$ bounded by a closed simple plane curve.
...
Suppose $\gamma$ is a closed simple smooth plane curve, and $\sigma$ is a circle.
...
Construct an example of a closed simple smooth plane curve $\gamma$ with only 4 vertices that crosses a given circle at arbitrarily many points. 
\end{thm}
