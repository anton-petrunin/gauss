...
The Euclidean plane $\mathbb{R}^2$ and space $\mathbb{R}^3$ are the main examples of metric spaces (see Section~\ref{sec:metric-spcaes}) one should keep in mind.
...
From Section~\ref{sec:analysis}, we know that the following function is smooth:
\[f(t)=
\begin{cases}
0&\text{if}\ t\le 0,
\\
