...
The Euclidean plane and space are the main examples of metric spaces  one should keep in mind.
...
%% A "smooth closed curve" hasn't been defined
...
For example, the unit circle in the plane can be described by the $2{\cdot}\pi$-periodic parametrization $\gamma(t)=(\cos t,\sin t)$. A curve equipped with a periodic parametrization is called a \emph{closed} curve.
...
In the reverse direction, any periodic parametrized curve yields a loop. 
Notice however, that the closed curve described by a smooth loop might fail to be smooth at its base; an example is shown on the diagram.
