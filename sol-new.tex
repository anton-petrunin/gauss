...
Apply \ref{ex:convex-lens} and the bow lemma (\ref{lem:bow}) to the arc of $\gamma$ from $p$ to $q$.
...
\end{align*}
Show and use that $f$ is concave and $f(0)\z=0$.
