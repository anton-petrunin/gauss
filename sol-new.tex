...
\parit{Remarks.}
If one assumes only that $\beta([0,1])\supset\alpha([0,1])$, then the statement follows from the following fact: \emph{the length of simple curve equals to the 1-dimensional Hausdorff measure of its image} \cite[Lemma 3.2]{falconer}.
