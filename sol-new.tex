...
\parbf{\ref{ex:proper-saddle}.} Look at the the pseudosphere described in \ref{ex:principal-revolution:pseudosphere}.
...
Consider equilateral triange $[pxy]_\Sigma$ with $|p-x|_\Sigma=|p-y|_\Sigma=R$;
set $\alpha=\measuredangle\hinge xpy$ and $\beta=\measuredangle\hinge ypx$.
Denote by $\sigma$ the arc of $\partial \Delta$ from $x$ to $y$.
Note that $[pxy]_\Sigma$ lies in region bounded by $[p,x]$, $[p,y]$, and $\sigma$.
Apply Gauss--Bonnet formula to show that $\tgc\sigma>\pi-\alpha-\beta$.
Use \mbox{\ref{mang<angk}} to find a lower bound on $\pi-\alpha-\beta$ in terms of $|x-y|_\Sigma$ and $R$.
Apply it for $|x-y|_\Sigma\to0$, and make a conclusion.
...
\parbf{\ref{ex:moon-}.}
Mimic the proof of \ref{thm:moon-orginal}.
