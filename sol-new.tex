...
However, for a lasso the answer is noticeably greater.

\parit{Source:}
We learned this problem from Joel Fine, who attributed it to Frederic Bourgeois \cite{fine}; see also \cite[Problem 12]{khesin-tabachnikov}
