...
\parit{Remarks.}
If one assumes only that $\beta([0,1])\supset\alpha([0,1])$, then the problem becomes harder;
it follows from the following fact: \emph{the length of simple curve equals to the 1-dimensional Hausdorff measure of its image} \cite[Theorem 2.6.2]{burago-burago-ivanov}.
...
\parbf{\ref{ex:tc(convex)}.}
Apply \ref{obs:tantrix}.
