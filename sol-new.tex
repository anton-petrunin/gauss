...
\parit{Remark.}
Note that the partition $(\tau_i)$ is not arbitrary, therefore the inequality might be strict;
it might happen if $\beta$ runs back and forth along $\alpha$.
...
Estimate the integral of the Gauss curvature over the entire surface and over a disc surrounded by a geodesic loop.
