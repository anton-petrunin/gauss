...
%Observe that the tangent indicatrix $\tan$ of of $\gamma$ is a smooth simple spherical curve.
%Show that each point of $\gamma$ with vanishing torsion corresponds to a point on $\tan$ with vanishing geodesic curvature.

%Generalize \ref{thm:4-vert-supporting} to spherical curves and geodesic curvature (see Section~\ref{sec:Darboux}). 
