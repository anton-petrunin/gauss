...
\parbf{\ref{ex:positive-gauss-0} + \ref{ex:positive-gauss}.}
...
Imagine that there is some air pressure in the pentagon, it should not move it; so the total force should vanish.
