...
Choose a coordinate system so that the $(x,y)$-plane supports $\Sigma$ at the origin, so $\Sigma$ lies in the upper half-space. %???+PIC
...
Conclude that $\Pi$ cuts from $\Sigma$ a compact region as well. %???+PIC
