...
smooth regular curves is called a \index{surface!with boundary}\emph{surface with boundary}; such curves form the \index{boundary line}\emph{boundary line} of the surface.
