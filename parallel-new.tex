...
If $\gamma$ is only piecewise smooth and/or not covered by one chart we can subdivide it into smooth arcs $\gamma_1,\dots,\gamma_n$ such that each $\gamma_i$ lies in one chart.
...
Show that the parallel transport along $\gamma$ in $\Sigma_1$
coincides with the parallel transport along $\gamma$ in $\Sigma_2$.
\end{thm}
...
Denote by $\phi(t)$ the signed angle from $\tan (t)$ to ${\vec v} (t)$.
Let us show that 
