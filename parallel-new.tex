...
The first is a thaut experiment with a bike wheel suggested by Mark Levi \cite{levi}.
...
For that reason, we use the same notation $\tgc\gamma$ as for total signed curvature; if we need to emphasize that we consider $\gamma$ as a curve in $\Sigma$, we write $\tgc\gamma_\Sigma$.\index{10psi@$\tgc\gamma$, $\tgc\gamma_\Sigma$ (total geodesic curvature)}
