...
Moreover, the arc $\tan_1|_{[s,s_0]}$ lies in one of the unit semicircle with endpoints $\vec u_1$ and $-\vec u_1$.
It follows that 
\[\measuredangle(\tan_1(s),\vec u_1)=\length (\tan_1|_{[s,s_0]}).\]
By \ref{obs:S2-length}, we also have 
\[\measuredangle(\tan_2(s),\vec u_2)\le \length (\tan_2|_{[s,s_0]}).\]
...
\\
&\ge \measuredangle(\tan_2(s),\vec u_2)=
\\
...
\]
The cosine is decreasing in the interval $[0,\pi]$.
Therefore, \ref{<gamma',u} implies 
