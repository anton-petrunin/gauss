...
\parit{Proof; \ref{SHORT.prop:convex-monotone:closed}.}
...
Since the unit circle is compact, we can pass to a subsequence of $(x_n)$ such that $\vec v_n$ converges to a unit vector, say $\vec v$.
...
Therefore, by \ref{obs:tantrix}, \ref{prop:convex-monotone}%ref to next chap
...
Use part \ref{SHORT.ex:length-dist:>} to give another solution of \ref{ex:sef-intersection:>pi}. %???ref to next chap
\end{subthm}
