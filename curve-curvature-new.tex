...
\frac{|\tan'|}{|\gamma'|}.
\end{align*}
It follows that \textit{the tangent indicatrix of a smooth curve $\gamma$ is smooth if the curvature of $\gamma$ does not vanish}.
...
The following lemma proved by Erhard Schmidt \cite{schmidt}; it generalizes the result of by Axel Schur \cite{shur}.
