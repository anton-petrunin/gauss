...
Tangent indicatrix of a smooth regular closed convex plane curve $\gamma$ defines a \index{monotonic map}\emph{monotonic map}  $\tan\:\mathbb{S}^1\to \mathbb{S}^1$;
...
\parit{Proof of \ref{prop:fenchel=}; if part.}
