...
A map $f\:\Sigma_1\to \Sigma_2$ is called \index{length-nonincreasing}\emph{length-nonincreasing} if, for any curve $\gamma$ in $\Sigma$ we have $\length\gamma\z\ge \length (f\circ\gamma)$. 
...
\index{normal!filed}\emph{normal filed};
