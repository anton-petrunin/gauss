...
Suppose ${p_1}= s(p_0)\in\Sigma_1$ for some chart $s$ of $\Sigma_1$;
observe that 
...
The value $\jac_{p_1} r$ has the following geometric meaning:
if $S_1$ is a region in $\T_{p_1}$ and $S_2=(d_{p_1} r)(S_1)$, then
\[\area S_2=\jac_{p_1} r \cdot \area S_1.\]
