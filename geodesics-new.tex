...
Therefore, it can be rewritten as the following system of two real equations
\[
\begin{cases}
...
In fact, it is easy to see that $\Dom(\exp_p)$ is \index{star-shaped}\emph{star-shaped} in $\T_p$;
