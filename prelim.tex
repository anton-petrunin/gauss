...
The first section in this chapter about metric spaces should be read before going further.
The rest of the chapter should be used as a quick reference while reading the rest of the book;
...
The sum of all the internal angles of an $n$-gon is $(n-2)\cdot\pi$. 
\end{thm}
...
A map $\bm{f}\:\mathbb{R}^m\to\mathbb{R}^n$ can be thaut of as an array of its coordinate functions 
...
А function $f$ is called \index{convex!function}\emph{(strictly) convex} if 
