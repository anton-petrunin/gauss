...
\item  the function $w\:(\bm{u},t_0,t)\mapsto \bm{x}(t)$ has an open domain of definition in $\Omega\times \mathbb{R}$ that contains all points $(\bm{u},t_0,t_0)$ for $(\bm{u},t_0)\in \Omega$, and $w$ is smooth in this domain.
\end{enumerate}
